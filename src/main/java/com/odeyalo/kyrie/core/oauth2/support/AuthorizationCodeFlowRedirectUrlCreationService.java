 ...
 * @version 1.0
 */
public class AuthorizationCodeFlowRedirectUrlCreationService implements RedirectUrlCreationService {
    ...
    public String createRedirectUrl(AuthorizationRequest request, Oauth2Token token) {
        if (!(token instanceof AuthorizationCode)) {
            throw new UnsupportedOperationException(String.format(
                    ...
                    AuthorizationCodeFlowRedirectUrlCreationService.class.getSimpleName(),
